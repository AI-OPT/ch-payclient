 ...
 *       &lt;sequence>
 *         &lt;element name="GrpHdr" type="{712.001.01}grpHdr"/>
 *         &lt;element name="GrpBody" type="{712.001.01}grpBody"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "RespInfo", namespace = "712.001.01")
public class RespInfo   implements XmlBodyEntity {

    @XmlElement(name = "GrpHdr", namespace = "712.001.01", required = true)
    protected GrpHdr grpHdr;
    @XmlElement(name = "GrpBody", namespace = "712.001.01", required = true)
