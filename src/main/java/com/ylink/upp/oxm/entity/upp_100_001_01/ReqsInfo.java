 ...
 *       &lt;sequence>
 *         &lt;element name="GrpHdr" type="{100.001.01}grpHdr"/>
 *         &lt;element name="GrpBody" type="{100.001.01}grpBody"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "ReqsInfo", namespace = "100.001.01")
public class ReqsInfo implements XmlBodyEntity {

    @XmlElement(name = "GrpHdr", namespace = "100.001.01", required = true)
    protected GrpHdr grpHdr;
    @XmlElement(name = "GrpBody", namespace = "100.001.01", required = true)
