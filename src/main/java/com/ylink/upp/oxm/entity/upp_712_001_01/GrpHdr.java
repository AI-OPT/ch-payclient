 ...
 *       &lt;sequence>
 *         &lt;element name="MerNo" type="{712.001.01}Max50Text"/>
 *         &lt;element name="CreDtTm" type="{712.001.01}Exact14Text"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "grpHdr", namespace = "712.001.01", propOrder = {
    "merNo",
    "creDtTm",
    "tranType"    
})
public class GrpHdr {
    ...
    @XmlElement(name = "MerNo", namespace = "712.001.01", required = true)
    protected String merNo;
    @XmlElement(name = "CreDtTm", namespace = "712.001.01", required = true)
