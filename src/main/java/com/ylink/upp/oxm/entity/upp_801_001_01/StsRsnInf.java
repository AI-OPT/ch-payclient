 ...
 *       &lt;sequence>
 *         &lt;element name="OrgMsgId" type="{599.001.01}XmlType"/>
 *         &lt;element name="BusiSn" type="{599.001.01}Max1000Text" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "stsRsnInf", namespace = "801.001.01", propOrder = {
    "orgMsgId",
    "busiSn"
})
public class StsRsnInf {

    @XmlElement(name = "OrgMsgId", namespace = "801.001.01", required = true)
    @XmlJavaTypeAdapter(CollapsedStringAdapter.class)
    protected String orgMsgId;
    @XmlElement(name = "BusiSn", namespace = "801.001.01")
