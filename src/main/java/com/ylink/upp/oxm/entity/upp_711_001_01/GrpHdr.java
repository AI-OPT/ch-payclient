 ...
 *       &lt;sequence>
 *         &lt;element name="MerNo" type="{711.001.01}ExactMax50Text"/>
 *         &lt;element name="CreDtTm" type="{711.001.01}Exact14Text"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "grpHdr", namespace = "711.001.01", propOrder = {
    "merNo",
    "creDtTm",
    "tranType"    
})
public class GrpHdr {
    ...
    @XmlElement(name = "MerNo", namespace = "711.001.01", required = true)
    protected String merNo;
    @XmlElement(name = "CreDtTm", namespace = "711.001.01", required = true)
