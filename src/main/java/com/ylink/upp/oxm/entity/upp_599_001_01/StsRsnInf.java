...
@XmlType(name = "stsRsnInf", namespace = "599.001.01", propOrder = {
    "orgMsgId",
    "busiSn"
})
public class StsRsnInf {

    @XmlElement(name = "OrgMsgId", namespace = "599.001.01", required = true)
    @XmlJavaTypeAdapter(CollapsedStringAdapter.class)
    protected String orgMsgId;
    @XmlElement(name = "BusiSn", namespace = "599.001.01")
