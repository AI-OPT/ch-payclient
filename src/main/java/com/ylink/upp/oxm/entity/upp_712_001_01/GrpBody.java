 ...
 *       &lt;sequence>
 *         &lt;element name="StsRsn" type="{712.001.01}stsRsn"/>
 *         &lt;element name="StsRsnInf" type="{712.001.01}stsRsnInf"/>
 *         &lt;element name="Resv" type="{712.001.01}Max128Text" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "grpBody", namespace = "712.001.01", propOrder = {
    "stsRsn",
    "stsRsnInf",
    "resv"
})
public class GrpBody {
    ...
    @XmlElement(name = "StsRsn", namespace = "712.001.01", required = true)
    protected StsRsn stsRsn;
    @XmlElement(name = "StsRsnInf", namespace = "712.001.01", required = true)
    protected StsRsnInf stsRsnInf;
    @XmlElement(name = "Resv", namespace = "712.001.01")
