 ...
 *       &lt;sequence>
 *         &lt;element name="MerNo" type="{599.001.01}Max32Text"/>
 *         &lt;element name="CreDtTm" type="{599.001.01}Exact14Text"/>
 *         &lt;element name="TranType" type="{599.001.01}XmlType"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "grpHdr", namespace = "599.001.01", propOrder = {
    "merNo",
    "creDtTm",
    "tranType"
})
public class GrpHdr {
    ...
    @XmlElement(name = "MerNo", namespace = "599.001.01", required = true)
    protected String merNo;
    @XmlElement(name = "CreDtTm", namespace = "599.001.01", required = true)
    protected String creDtTm;
    @XmlElement(name = "TranType", namespace = "599.001.01", required = true)
